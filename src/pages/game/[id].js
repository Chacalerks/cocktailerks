...
import useCocktailDetailsIngredients from '../../hooks/useCocktailDetailsIngredients';
import useIngredients from '../../hooks/useIngredients';


import { Button, Grid, Box, Typography, TextField, Container } from '@mui/material';
const CocktailGamePage = () => {
    const router = useRouter();
    const { id } = router.query;
    const { cocktail, ingredients, additionalIngredients } = useCocktailDetailsIngredients(id);
...
export default CocktailGamePage;
